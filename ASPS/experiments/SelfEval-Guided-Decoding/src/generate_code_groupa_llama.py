...
def parse_args():
    ...
    parser.add_argument("--output_group_label", default="groupA", type=str)
...
def groupa_generation_result(decoder, context, distill_metadata=None):
    ...
    try:
        for batch_idx in tqdm(range((len(inputs) + args.batch_size - 1) // args.batch_size)):
            ...
            for exp in batch:
                ...
                raw_results = groupa_generation_result(
                    decoder,
                    full_prompt,
